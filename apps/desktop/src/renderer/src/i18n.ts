const en = {
  ...
  'bots.threadEmpty': '{name} answers from your memory. Work you repeat \u2014 a weekly roundup, a draft you always need \u2014 save as a task above and run it with one click.',
