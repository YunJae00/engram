const en = {
  ...
  'bots.accept': 'Create',
  'bots.nameLabel': 'Name',
  'bots.purposeLabel': 'What is this bot for? It answers within this charter.',
  'bots.create': 'Create bot',
  'bots.delete': 'Delete',
  'bots.deleteArmed': 'Really delete?',
  'bots.placeholder': 'Message {name}\u2026',
  'bots.sendErrand': 'Run this as an errand \u2014 it researches on its own and the result lands in review',
  'bots.threadEmpty': '{name} is ready \u2014 it answers from your memory, and the ghost button turns a message into an errand.',
  'bots.emptyTitle': 'No bots yet',
  'bots.emptyHint': 'A bot is a colleague with a charter: give it a name and what it is for. Suggestions on the left grow from what you actually work on.',
