const en = {
  ...
  'press.ask': 'It wants to press “{words}” — that sends or saves something. The page is above; have a look.',
  'press.askHint': 'You can press it yourself in the view above instead — it is live.',
  'press.go': 'Press it',
