const en = {
  ...
  'mission.running': 'Show running',
  'mission.layout': 'Monitor layout',
  'mission.panels': '{count} panels',
  'mission.pause': 'Pause previews',
  'mission.resume': 'Resume previews',
  ...
  'mission.select': 'Choose a chat',
  'mission.working': 'Running',
  'mission.ready': 'Ready',
  'mission.open': 'Open {name}',
  'mission.enter': 'Open chat',
  'mission.empty': 'Room for more',
  'mission.emptyHint': 'Create a comet to follow another stream of work here.',
  'mission.live': 'Live preview',
