const en = {
  ...
  'bots.taskAdd': 'Save this as a one-press task',
  'bots.routines': 'Routines',
  'bots.routinesHint': 'Jobs you showed it once in the browser — run them here.',
  'bots.taskHint': 'Work you repeat — a weekly roundup, a draft you always need. Saved here, it runs with one press.',
  'bots.taskName': 'Call it something you will recognise',
  'bots.taskGoal': 'Say the whole job, as you would to a colleague',
  'bots.taskSave': 'Save',
