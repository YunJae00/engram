const en = {
  ...
  'bots.threadEmpty': 'Ask {name} anything \u2014 it answers from your own memory first. Under every answer there is a button to send the same question to the web, and one to keep it as a task you can re-run with a single press.',
