const en = {
  ...
  'tour.tidyBody': 'Captures and edits are organized on their own a moment after they land, and the librarian asks before changing anything it is unsure about. There is nothing to press.',
