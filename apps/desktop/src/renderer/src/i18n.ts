const en = {
  ...
  'routines.stepOpen': 'Open page',
  'routines.stepClick': 'Click',
  'routines.stepType': 'Type',
  'routines.stepRead': 'Read page',
  'routines.stepUrl': 'https://…',
  'routines.stepTarget': 'The words on it — e.g. "Notices"',
  'routines.stepText': 'Text to type',
  'routines.stepReadNote': 'collects what the page says',
  'routines.addStep': 'Add a step',
  ...
  'routines.wallLogin': 'This page needs you to sign in. Do it in the agent window, then continue.',
  'routines.wallCaptcha': 'This page wants proof of a human. Clear it in the agent window, then continue.',
  ...
  'routines.teachWatching': 'The agent window is open — do the work once, exactly as you would. I am watching and writing the steps down.',
  ...
  'routines.teachEmpty': 'Nothing was recorded — do the work in the agent window, then press Done.',
