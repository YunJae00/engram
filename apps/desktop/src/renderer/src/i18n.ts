const en = {
  ...
  'mission.say': 'Message\u2026',
  'mission.summary': '{count} running · Your work, side by side',
  'mission.layout': 'Monitor layout',
  'mission.panels': '{count} panels',
  'mission.error': 'Some previews could not refresh. Retrying…',
  'mission.waiting': 'Ready for your next message.',
  'mission.working': 'Running',
  'mission.running': 'Running',
  'mission.stateWaiting': 'Needs input',
  'mission.stateError': 'Needs attention',
  'settings.loading': 'Loading settings',
  'settings.loadFailed': 'Settings could not be loaded. Try again.',
  'settings.retry': 'Try again',
  'mission.ready': 'Ready',
  'mission.open': 'Open {name}',
  'mission.enter': 'Open chat',
  'mission.chat': 'Conversation',
  ...
  'settings.brainTitle': 'AI connection',
  'settings.generalTitle': 'General',
  'settings.appTitle': 'App & support',
  'settings.brainHint': 'Choose who answers. Use your existing subscription.',
  ...
  'sidebar.chats': 'Chats',
  'sidebar.openRoutines': 'Open routines',
  'sidebar.more': 'More options',
  'sidebar.rename': 'Rename',
  'sidebar.delete': 'Delete',
  'sidebar.deleteConfirm': 'Delete?',
  'sidebar.noChats': 'No chats yet',
  'sidebar.noRoutines': 'No routines yet',
  'sidebar.search': 'Search Cosmos',
  'sidebar.aiConnected': '{name} connected',
  'sidebar.aiAttention': '{name} needs attention',
  ...
  'bots.keepAsk': 'That took a few steps. Shall I keep it as a routine? Here is what I would save:',
  'bots.keepRename': 'Change the name',
  'bots.keepYes': 'Save the routine',
  ...
  'live.fold': 'Fold the page away',
  'live.unfold': 'Show the page again',
  'live.reset': 'Close this page and start clean',
  'live.empty': 'Type an address above to open a page — the comet works in this same panel.',
  'web.show': 'Show the page panel',
  'web.hide': 'Hide the page panel',
  'live.refresh': 'Take the picture again',
  'live.close': 'Close',
  ...
  'live.closed': 'The browser closed — this is the last it showed',
  'press.ask': 'It wants to press “{words}” — that sends or saves something.',
  'press.askHint': 'Review the current page before allowing this action. The assistant is waiting; nothing is sent by this request alone.',
  'press.go': 'Allow once',
  'press.mine': 'I will do it',
  'press.always': 'Always on {host}',
  ...
  'bots.stepPress': 'Pressing “{arg}” on the page',
  'bots.stepType': 'Typing into “{arg}”',
  'bots.stepChoose': 'Choosing from “{arg}”',
  'bots.stepScroll': 'Scrolling the page ({arg})',
  'bots.stepHover': 'Resting on “{arg}”',
  'bots.stepKey': 'Pressing the {arg} key',
  ...
  'routines.hint': 'What a comet learned doing a job on a website, kept so the next time starts from it. Replaying one walks the same pages and clicks and leaves what it read in review — no AI involved, so it runs even when the machine is busy.',
  ...
  'routines.empty': 'Nothing kept yet. Ask a comet to do something on a website, and what it learns is offered here afterwards.',
  ...
  'settings.deskJournal': 'Remember app activity',
  'settings.sessionWatch': 'Remember coding sessions',
