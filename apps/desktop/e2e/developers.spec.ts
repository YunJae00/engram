...
async function historyFixture() {
  ...
  await expect(page.getByRole('button', { name: 'Choose session', exact: true })).toContainText('Imported conversation')
  await page.getByTestId('developers-view').getByTestId('model-picker').click()
  await expect(page.getByTestId('provider-pick-claude')).toBeDisabled()
  await expect(page.getByTestId('model-pick-fixture-model')).toBeVisible()
  await screenshot('developers-models.png')
  await page.keyboard.press('Escape')
  await page.getByTestId('developers-view').getByTestId('effort-picker').click()
  ...
  await expect(page.getByTestId('developers-view').getByTestId('effort-picker')).toHaveText('High')
