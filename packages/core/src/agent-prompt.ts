...
export function openRuleLines(): string[] {
  return [
    ...
    'Write to the person in the language of their message - not the language of their notes, nor of the pages read; a term from a source may follow in its own language, in brackets.',
